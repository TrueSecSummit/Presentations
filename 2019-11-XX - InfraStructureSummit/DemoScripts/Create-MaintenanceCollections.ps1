...
.EXAMPLE
    ...
    C:\Users\jbenz001-admin\Desktop\MW-Scripts\Create-MaintenanceCollections.Ps1 -LimitingCollectionID "SMS00001" -NumberofDays 5 -FolderPath "PR1:\DeviceCollection\Demo"
    .\Create-MaintenanceCollections.Ps1 -LimitingCollectionID "SMS00001" -NumberofDays 5 -FolderPath "PR1:\DeviceCollection\Demo"
